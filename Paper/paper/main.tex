...
(\texttt{[CORRESPONDING-AUTHOR EMAIL]})\\[0.1em]
\small ORCID: Fankai Dong \texttt{[ORCID iD]}; Olatunji Johnson \texttt{[ORCID iD]}}
\date{\today}
...
% ===========================================================================
\textbf{Fankai Dong:} methodology, software, formal analysis, investigation,
visualisation, writing --- original draft. \textbf{Olatunji Johnson:}
conceptualisation, methodology, supervision, writing --- review and editing.
\emph{[Please confirm the CRediT roles reflect the actual division of work.]}

% ===========================================================================
\section*{Funding}
% ===========================================================================
\emph{[Funding statement to be confirmed --- e.g.\ ``This research received no
